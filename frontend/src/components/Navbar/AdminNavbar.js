...
export default function AdminPanel() {
    ...
    function declined() {
      navigate("/admin/declined");
    }

    function booking() {
        navigate("/admin/slotted");
      }
                        ...
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            ...
                            <li className="rounded-sm">
                                ...
                                >
                                    ...
                                    <span className="text-gray-100"onClick={approved}>Approved</span>
                                </a>
                            </li>
                            <li className="rounded-sm">
                                <a
                                ...
                                >
                                    ...
                                    <span className="text-gray-100"onClick={declined}>Declined</span>
                                </a>
                            </li>
                            <li className="rounded-sm">
                                <a
                                ...
                                >
                                    ...
                                    <span className="text-gray-100"onClick={booking}>Slot Booking</span>
                                </a>
                            </li>
